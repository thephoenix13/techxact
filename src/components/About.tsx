  ...
  const whatSetsUsApart = [
    {
      ...
      description:
        "Our AI understands the nuances of both technical and business roles, ensuring every candidate is a strategic fit.",
    },
    {
      icon: Zap,
      ...
      <div className="section-container">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-4xl mx-auto leading-relaxed">
            At Techxact, we specialize in connecting ambitious organizations with top-tier talent across both IT and
            Non-IT domains. We are not just recruiters – we are strategic hiring partners committed to helping
            businesses scale with precision, efficiency, and the right people.
          </p>
          <p className="text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            TechXact is built for companies that demand accuracy in hiring — whether you're scaling your IT
            infrastructure or expanding your operations team. Our platform intelligently matches candidates to roles
            across industries, ensuring every hire is a strategic win.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                We support hiring managers and job seekers alike — from coders to coordinators.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <p className="text-muted-foreground mb-6">We help tech-driven companies hire for roles in:</p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <p className="text-muted-foreground mb-6">We deliver end-to-end recruitment solutions across:</p>
              <div className="space-y-3">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg mb-16 text-center">
          ...
          <blockquote className="text-xl italic text-gray-600 mb-4">
            "TechXact helped us hire a DevOps engineer and a finance controller in under a week. It's like having two
            platforms in one."
          </blockquote>
        ...
        <div className="text-center bg-gradient-to-br from-primary/5 to-accent-cyan/5 rounded-2xl p-12 border border-primary/10">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            If you believe talent is the foundation of growth, let's build that foundation together. At Techxact, we
            don't just fill vacancies — we build high-performing teams.
          </p>
          <div className="text-muted-foreground">
            📧 Drop us a message:{" "}
            <a href="mailto:info@techxacts.com" className="text-primary hover:underline">
              info@techxacts.com
            </a>{" "}
            | 🌐 Website:{" "}
            <a href="https://techxacts.com/" className="text-primary hover:underline">
              https://techxacts.com/
            </a>
          </div>
        </div>
